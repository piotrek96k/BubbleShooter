...
import com.piotrek.exception.IllegalValueException;
import com.piotrek.resources.PreferencesKey;
...
public class SoundPlayer {
    ...
    private final Set<MediaPlayer> gameplayEffectsPlayers;
    ...
    {
        gameplayEffectsPlayers = new HashSet<>();
        effectsMuted = Resources.PREFERENCES.getBoolean(PreferencesKey.EFFECTS_MUTED.getKey(), false);
        musicMuted = Resources.PREFERENCES.getBoolean(PreferencesKey.MUSIC_MUTED.getKey(), false);
        effectsVolume = Resources.PREFERENCES.getDouble(PreferencesKey.EFFECTS_VOLUME.getKey(), 0.5);
        musicVolume = Resources.PREFERENCES.getDouble(PreferencesKey.MUSIC_VOLUME.getKey(), 0.5);
    }
    ...
    public void saveUserPreferences() {
        Resources.PREFERENCES.putBoolean(PreferencesKey.EFFECTS_MUTED.getKey(), effectsMuted);
        Resources.PREFERENCES.putBoolean(PreferencesKey.MUSIC_MUTED.getKey(), musicMuted);
        Resources.PREFERENCES.putDouble(PreferencesKey.EFFECTS_VOLUME.getKey(), effectsVolume);
        Resources.PREFERENCES.putDouble(PreferencesKey.MUSIC_VOLUME.getKey(), musicVolume);
    }
